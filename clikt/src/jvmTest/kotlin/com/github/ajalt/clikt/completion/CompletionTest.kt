...
class CompletionTest {
    ...
    @Test
    fun `custom fish completions with multiple subcommands`() {
        env.set("TEST_COMPLETE", "fish")
        class C : TestCommand(autoCompleteEnvvar = "TEST_COMPLETE", name = "cli")
        class Sub : TestCommand()
        class SubCommand : TestCommand(name = "sub-command")
        class LongSubCommand : TestCommand(name = "long-sub-command")
        ...
        |# Command completion for cli
        |# Generated by Clikt
        |
        |### Declaring root subcommands
